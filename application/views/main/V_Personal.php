  ...
  <div class="col-lg-12">
    <div class="col-md-12">
      <div class="content-fluid text-left" style="background-color:white;margin-top:25px;padding-top: 10px;padding-left: 50px;
        padding-bottom: 20px;">
        <h3 style="font-family: Spartan;"><i class="fa fa-bullhorn"></i> <b>PERSONAL BROADCAST</b></h3>
      </div>
        <div style="margin-top: 10px;margin-bottom: 10px"></div>
            <div class="content-fluid text-left" style="background-color:#708090;padding-top: 20px;padding-left: 50px;padding-bottom: 50px;min-height: 200px">
              <div class="col-md-4">
              ...
              <div class="col-md-4 pull-right">
                    ...
                    <br/> <span style="font-size: 15px;">You are going to send message for <b><?php echo $user[0]['full_name']?></b></span></span>
              </div>
                  <br/>
            </div>

          <div class="content-fluid col-md-12" style="background-color:white;padding-top: 10px;padding-left: 50px;padding-bottom: 50px;margin-top: 10px">
            <div class="content-fluid bg-white bg-light border-top border-info" style="margin-left:20px;margin-top:30px; height:100%">
                    ...
                    <tr >
                        ...
                        <td style="padding-bottom: 10px;width:20%">
                          <input class="form-control" value="<?php echo $arrai['nama'] ?>" placeholder="Insert Sender" type="text" name="txtFrom" id="no_telp_id" style="margin-left:5px; color:black; width:500px;">
                        </td>
                    </tr>
                    <tr>
                        <td><b>To</b></td>
                        <td style="padding-bottom: 10px"><input readonly placeholder="Insert Recepient" class="form-control" type="text" name="txtRecepient" id="txt_subject" style="margin-left:5px; color:black; width:500px;" value="<?php echo $user[0]['phone_num']?>"></td>
                    </tr>
                    <tr>
                        <td><b>Subject</b></td>
                    ...
                    <tr>
                        ...
                        <td class="text-left" style="padding-left: 5px;padding-bottom: 10px" >
                          <button type="button" data-target="#bold" data-toggle="modal" class="zoom btn btn-sm btn-danger" style="margin-bottom:5px;"><i class="fa fa-bold"></i> Bold</button>
                          <button type="button" data-target="#italic" data-toggle="modal" class="zoom btn btn-sm btn-warning" style="margin-bottom:5px;"><i class="fa fa-italic"></i> Italic</button>
                          <button type="button" data-target="#strikethrough" data-toggle="modal" class="zoom btn btn-sm btn-success" style="margin-bottom:5px;"><i class="fa fa-strikethrough"></i> Strike</button>
                          <button type="button" onclick="resetFunction()" class="zoom btn btn-sm btn-primary" style="margin-bottom:5px;"><i class="fa fa-eraser"></i> Reset</button>
                          <button type="button" onclick="copyFunction()" class="zoom btn btn-sm btn-default" style="margin-bottom:5px;"><i class="fa fa-copy"></i> Copy All</button>
                    ...
                    <tr>
                      <td></td>
                      <td style="padding-bottom: 10px"><textarea placeholder="Insert Body" name="message" class="form-control" id="text_pesan" cols="50px" rows="10px" style="margin-left:5px;color:black; width:500px;"></textarea></td>
                      <!-- <td style="width:10%;padding-top:180px;padding-right:0px" class="text-left"><button type="submit" class="zoom btn btn-sm btn-default " style="margin-left:20px;width: 100px;background-color:#708090;color:white;"><i class="fa fa-paper-plane"></i> SEND</button></td> -->
                    </tr>
                    <tr><td></td>
                      <td>
            ...
            <div class="box-body">
              ...
              <table id="tblSneak" class="text-left" style="min-width: 100%">
                <tr>
                  <td></td>
            ...
            <div class="box-body no-padding" style="">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="#"><i class="fa fa-envelope-o"></i> Sent <span class="label label-warning pull-right">65</span></a></li>
                <li><a href="#"><i class="fa fa-file-text-o"></i> Drafts <span class="label label-warning pull-right">65</span></a></li>
